...
public class InboundController {
    ...
    public ResponseEntity<PutawayResponseDto> receive(@RequestBody ReceiveRequestDto request) {
    ...
    @PostMapping("/confirm")
    @PreAuthorize("hasAuthority('INBOUND_RECEIVE')")
    public ResponseEntity<InventoryLot> confirm(@RequestBody ConfirmPutawayRequestDto request) {
